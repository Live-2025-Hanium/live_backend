...
class StorageServiceTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(storageService, "baseUrl", "https://test-bucket.s3.amazonaws.com");
    }
    ...
    void generatePresignedUploadUrl_Success() throws Exception {
        ...
        PresignedUrlResponseDto responseDto = storageService.generatePresignedUploadUrl(requestDto);
    ...
    void generatePresignedUploadUrl_Failure_When_S3_Throws_Exception() {
        ...
        CustomException exception = assertThrows(CustomException.class, () -> {
            storageService.generatePresignedUploadUrl(requestDto);
        });
