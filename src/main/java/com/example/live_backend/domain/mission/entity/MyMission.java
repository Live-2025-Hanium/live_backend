...
import com.example.live_backend.domain.mission.util.DayOfWeekListConverter;
import com.example.live_backend.domain.mission.util.LocalTimeListConverter;
...
public class MyMission {
    ...
    /**
     * MyMissionRequestDto, Member 로 부터 MyMission 엔티티를 생성하는 팩토리 메서드
     */
