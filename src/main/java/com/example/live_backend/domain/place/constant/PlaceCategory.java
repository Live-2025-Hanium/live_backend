...
public enum PlaceCategory {
    ...
    private static final Map<String, PlaceCategory> BY_KAKAO_CODE = 
        Arrays.stream(values())
            .collect(Collectors.toMap(PlaceCategory::getKakaoCode, e -> e));
    
    public static PlaceCategory fromCode(String code) {
        return BY_CODE.get(code);
    }
    
    public static PlaceCategory fromKakaoCode(String kakaoCode) {
        return BY_KAKAO_CODE.get(kakaoCode);
    }
    ...
    public boolean requiresSpecialFiltering() {
        return this == PSYCHIATRY;
    }
}